 ...
 * @author edgom
 */
public class Down2 extends Thread {

    public int Cant = 0;
    public Tablero_201602909 tab = null;
    public int V;
    public Down2(int cant, Tablero_201602909 tab, int v) {
        this.Cant = cant;
        this.tab = tab;
        this.V=v;
    }

    public void MoverDown2(int cantidad) throws InterruptedException {
        if (cantidad <= 0) {
            return;
        }
        if (ComprobarPos()) {
